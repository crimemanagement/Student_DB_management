            ...
            <div class="navbar-inner">
                ...
                <div class="collapse navbar-collapse" id="sidenav-collapse-main">
                    ...
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="attandence-page.php">
                                <i class="ni ni-planet text-orange"></i>
                                <span class="nav-link-text">Attandance</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="announcement-page.php">
                                        ...
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col ml--2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <h4 class="mb-0 text-sm">Proff. Xyz</h4>
                                                    </div>
                                    ...
                                    <a href="#!" class="list-group-item list-group-item-action">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col ml--2">
                                                <div class="d-flex justify-content-between align-items-center">
                                                    <div>
                                                        <h4 class="mb-0 text-sm">Proff. Xyzs</h4>
                                                    </div>
                                                    <div class="text-right text-muted">
